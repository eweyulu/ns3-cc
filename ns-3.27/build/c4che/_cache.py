...
CFLAGS_PYEMBED = ['-fno-strict-aliasing', '-fdebug-prefix-map=/build/python2.7-2.7.13=.', '-fstack-protector-strong', '-fwrapv']
CFLAGS_PYEXT = ['-fno-strict-aliasing', '-fdebug-prefix-map=/build/python2.7-2.7.13=.', '-fstack-protector-strong', '-fwrapv']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-fno-strict-aliasing', '-fdebug-prefix-map=/build/python2.7-2.7.13=.', '-fstack-protector-strong', '-fwrapv']
CXXFLAGS_PYEXT = ['-fno-strict-aliasing', '-fdebug-prefix-map=/build/python2.7-2.7.13=.', '-fstack-protector-strong', '-fwrapv', '-fvisibility=hidden', '-Wno-array-bounds']
...
EXAMPLE_DIRECTORIES = ['udp', 'energy', 'realtime', 'tcp', 'naming', 'wireless', 'stats', 'bbr-tests', 'matrix-topology', 'ipv6', 'traffic-control', 'tutorial', 'routing', 'udp-client-server', 'socket', 'error-model']
...
NS3_EXECUTABLE_PATH = ['/local/home/ndilo/Dropbox/Emily_Dell/ns3-cc/ns-3.27/build/src/fd-net-device', '/local/home/ndilo/Dropbox/Emily_Dell/ns3-cc/ns-3.27/build/src/tap-bridge']
...
VALGRIND_FOUND = True
VERSION = '3.27'
WITH_PYBINDGEN = '/local/home/ndilo/Dropbox/Emily_Dell/ns3-cc/pybindgen-0.17.0.post58+ngcf00cc0'
WL_SONAME_SUPPORTED = True
cfg_files = ['/local/home/ndilo/Dropbox/Emily_Dell/ns3-cc/ns-3.27/build/ns3/config-store-config.h', '/local/home/ndilo/Dropbox/Emily_Dell/ns3-cc/ns-3.27/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
